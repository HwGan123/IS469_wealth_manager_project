...
Use Streamlit as the main app UI.
...
This runs the LangGraph workflow directly in-process and streams agent logs in the UI, so no separate browser frontend or backend server is required.
